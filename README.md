<p align="center">
  <img src="./assets/readme/hero.svg" width="100%" alt="Codex Grok Build Session — controlled local Grok CLI collaboration with observable session state">
</p>

<p align="center">
  <a href="./docs/getting-started.md">快速开始</a> ·
  <a href="./docs/commands.md">命令手册</a> ·
  <a href="./docs/session-lifecycle.md">会话生命周期</a> ·
  <a href="./docs/troubleshooting.md">故障诊断</a> ·
...
| `smoke-test` | 创建、验证并删除一次测试会话 | 是，且自动清理 |

完整参数和返回字段见 [命令手册](./docs/commands.md)。
...
| 文档 | 内容 |
|---|---|
| [快速开始](./docs/getting-started.md) | 安装、首次检查、创建和继续会话 |
| [命令手册](./docs/commands.md) | 全部子命令、常用参数、输出和退出状态 |
| [会话生命周期](./docs/session-lifecycle.md) | 会话定位、完成判断、上下文与长任务协作 |
| [故障诊断](./docs/troubleshooting.md) | 启动、网络、超时、warning、进程和日志检查 |
| [实现说明](./docs/design.md) | 数据来源、辅助脚本职责与安全设计 |
| [CLI 速查](./references/cli-notes.md) | Grok 1.0.5 参数与版本观察 |
